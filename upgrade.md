...
Laravel 5.1.11 includes support for [authorization](/{{version}}/authorization) and [policies](/{{version}}/authorization). Incorporating these new features into your existing Laravel 5.1 applications is simple.
