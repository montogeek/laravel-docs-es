...
Para complementar la nueva estructura predefinida de la aplicación, los comandos de Artisan `make:provider`, `make:filter` y `make:request` fueron agregados al framework.
