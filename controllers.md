...
[Middleware](/5.0/middleware) may be specified on controller routes like so:
...
The Laravel [service container](/5.0/container) is used to resolve all Laravel controllers. As a result, you are able to type-hint any dependencies your controller may need in its constructor:
...
Of course, you may also type-hint any [Laravel contract](/5.0/contracts). If the container can resolve it, you can type-hint it.
