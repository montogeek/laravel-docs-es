...
Si prefieres usar una clase como compositor, lo cual provee el beneficio de ser resuelta a través de la aplicación gracias al [contenedor IoC](/4.1/ioc), lo harías así:
