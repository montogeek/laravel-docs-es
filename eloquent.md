...
Of course, you may also use `count`, `sum`, `max`, and other [aggregate functions](/{{version}}/queries#aggregates) provided by the [query builder](/{{version}}/queries). These methods return the appropriate scalar value instead of a full model instance:
