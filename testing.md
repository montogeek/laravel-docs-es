...
- [Definir y ejecutar tests](#defining-and-running-tests)
- [Entorno de pruebas](#test-environment)
- [Llamados a rutas desde tests](#calling-routes-from-tests)
- [Simular facades](#mocking-facades)
- [Aserción del framework](#framework-assertions)
- [Métodos de ayuda](#helper-methods)
- [Renovar la aplicación](#refreshing-the-application)
...
More information on creating seeds may be found in the [migrations and seeding](/page/migrations#database-seeding) section of the documentation.
