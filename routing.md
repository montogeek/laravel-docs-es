...
More information on handling 404 exceptions and using custom responses for these errors may be found in the [errors](/5.0/errors#handling-404-errors) section of the documentation.
